...
type User struct {
	...
	CustomerOrderTransactions []OrderTransaction       `gorm:"foreignKey:customer_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"customer_order_transactions,omitempty"`
	MitraOrderTransactions    []OrderTransaction       `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"mitra_order_transactions,omitempty"`
	CustomerRatings           []UserRating             `gorm:"foreignKey:customer_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"customer_ratings,omitempty"`
	MitraRatings              []UserRating             `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"mitra_ratings,omitempty"`
	CustomerRepeatOrders      []OrderTransactionRepeat `gorm:"foreignKey:customer_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"customer_repeat_orders,omitempty"`
	MitraRepeatOrders         []OrderTransactionRepeat `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"mitra_repeat_orders,omitempty"`
	SentMessages              []Message                `gorm:"foreignKey:sender_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"sent_messages,omitempty"`
	PaymentAccounts           []PaymentAccount         `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"payment_accounts,omitempty"`
	BeneficiaryTransactions   []BeneficiaryTransaction `gorm:"foreignKey:user_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"beneficiary_transactions,omitempty"`
	UsersTools                []UserTool               `gorm:"foreignKey:user_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"users_tools,omitempty"`
	ToolsCredits              []ToolCredit             `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"tools_credits,omitempty"`
	SubToolsCredits           []SubToolCredit          `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"sub_tools_credits,omitempty"`
	CreatedBanners            []BannerList             `gorm:"foreignKey:creator_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"created_banners,omitempty"`
	CreatedLayananServices    []LayananService         `gorm:"foreignKey:creator_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"created_layanan_services,omitempty"`
	CreatedNews               []NewsList               `gorm:"foreignKey:creator_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"created_news,omitempty"`
	CreatedSyaratKetentuan    []SyaratKetentuan        `gorm:"foreignKey:creator_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"created_syarat_ketentuan,omitempty"`
	MitraTransactions         []Transaction            `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"mitra_transactions,omitempty"`
	CustomerTransactions      []Transaction            `gorm:"foreignKey:customer_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"customer_transactions,omitempty"`
	MitraOrderChats           []OrderChat              `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"mitra_order_chats,omitempty"`
	CustomerOrderChats        []OrderChat              `gorm:"foreignKey:customer_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"customer_order_chats,omitempty"`
	CustomerOrderOffers       []OrderOffer             `gorm:"foreignKey:customer_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"customer_order_offers,omitempty"`
	MitraOrderOffers          []OrderOffer             `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"mitra_order_offers,omitempty"`
	CustomerNotifications     []Notification           `gorm:"foreignKey:customer_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"customer_notifications,omitempty"`
	MitraNotifications        []Notification           `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"mitra_notifications,omitempty"`
	AdminPrivacyPolicies      []PrivacyPolicy          `gorm:"foreignKey:admin_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"admin_privacy_policies,omitempty"`
	CustomerComplains         []Complain               `gorm:"foreignKey:customer_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"customer_complains,omitempty"`
	MitraSelectedOrders       []OrderSelectedMitra     `gorm:"foreignKey:mitra_id;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"mitra_selected_orders,omitempty"`
}
